...
export default function AllProducts() {
  ...
  let [currentProducts, setCurrentProducts] = useState(
    allProducts.slice(page[0], page[1])
  );
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((products) => {
        ...
        setCurrentProducts(products.data.slice(page[0], page[1]));
      })
      .catch((err) => {
        console.log(err);
      });
                ...
                <div className="card-body">
                  ...
                  <div className="btn-wrapper">
                    ...
                    <button
                      ...
                      onClick={() => dispatch(addToFav(device))}
                    >
                      Add to favourite
                    </button>
                  </div>
